                ...
                <div className="usa-banner__content usa-accordion__content" id="gov-banner">
                    <div className="grid-row grid-gap-lg">
                        <div className="usa-banner__guidance tablet:grid-col-6">
                            <img className="usa-banner__icon usa-media-block__img" src="../../assets/img/icon-dot-gov.svg"
                        ...
                        <div className="usa-banner__guidance tablet:grid-col-6">
                            <img className="usa-banner__icon usa-media-block__img" src="../../assets/img/icon-https.svg"
                                role="img" alt="" aria-hidden="true" />
                            <div className="usa-media-block__body">
                                <p>
                                    <strong>
                                ...
                                <span className="icon-lock"><svg xmlns="http://www.w3.org/2000/svg" width="52" height="64"
